<div class="max-w-4xl mx-auto px-4 py-10">
    <h1 class="text-3xl font-bold text-gray-800 mb-6 dark:text-gray-200">Contact Us</h1>
    ...
    <form wire:submit.prevent="sendMessage" class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 space-y-4">
        ...
        <textarea wire:model.defer="message" placeholder="Your Message" rows="5" required
    ...
    {{-- Google Map --}}
    <div class="mt-10">
        <h2 class="text-xl font-semibold mb-3 text-gray-800 dark:text-gray-200">Our Location</h2>
