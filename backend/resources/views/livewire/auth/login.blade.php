            ...
            <div class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
                <div class="p-4 sm:p-7">
                    <div class="text-center">
                        <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">{{ __('login.signin') }}</h1>
                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                            {{ __('login.no_account') }}
                            <a wire:navigate
                                class="text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                href="/register">
                                {{ __('login.signup_here') }}
                            </a>
                        </p>
                    </div>
                    ...
                    <form wire:submit.prevent="save">
                        <div class="grid gap-y-4">
                            ...
                            <div>
                                <label for="email"
                                    class="block text-sm mb-2 dark:text-white">{{ __('login.email') }}</label>
                                <div class="relative">
                            ...
                            <div>
                                <div class="flex justify-between items-center">
                                    <label for="password"
                                        class="block text-sm mb-2 dark:text-white">{{ __('login.password') }}</label>
                                    <a wire:navigate
                                        ...
                                        href="/forgot">{{ __('login.forgot_password') }}</a>
                                </div>
                                <div class="relative">
                            ...
                            <!-- End Form Group -->
                            <button type="submit"
                                class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">{{ __('login.signin_button') }}</button>
                        </div>
                    </form>
                    <!-- End Form -->
                </div>
