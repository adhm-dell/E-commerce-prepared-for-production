                ...
                <div class="p-4 sm:p-7">
                    <div class="text-center">
                        ...
                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                            {{ __('forgot_password.remember') }}
                            <a wire:navigate
                                class="text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                href="/login">
                                {{ __('forgot_password.signin_here') }}
                            </a>
                        </p>
                    </div>
                            ...
                            @if (session('success'))
                                <div class="mb-4">
                                    <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative"
                                        role="alert">
                                        <strong class="font-bold">{{ __('forgot_password.success_title') }}</strong>
                                        <br>
                                        <span class="block sm:inline">{{ __('forgot_password.success_msg') }}</span>
                                    </div>
                                </div>
                            @endif
                            <div class="grid gap-y-4">
                                ...
                                <div>
                                    <label for="email" class="block text-sm mb-2 dark:text-white">
                                        {{ __('forgot_password.email_label') }}
                                    </label>
                                    <div class="relative">
