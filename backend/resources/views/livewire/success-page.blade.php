<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-30 mx-auto rounded-lg">
    <section class="flex items-center font-poppins dark:bg-gray-800 rounded-lg">
        <div
            ...
            <div>
                        ...
                        <div class="flex items-center justify-center w-full pb-6 space-x-4 md:justify-start">
                            <div class="flex flex-col items-start justify-start space-y-2">
                                ...
                                <p class="text-sm leading-4 cursor-pointer dark:text-gray-400">
                                    {{ __('success.phone') }}: {{ $order->address->phone }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="flex flex-wrap items-center pb-4 mb-10 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <div class="w-full px-4 mb-4 md:w-1/4">
                        <p class="mb-2 text-sm leading-5 text-gray-600 dark:text-gray-400 ">
                            {{ __('success.payment_method') }}:</p>
                        <p class="text-base font-semibold leading-4 text-gray-800 dark:text-gray-400 capitalize">
                            {{ $order->payment_method == 'cod' ? __('success.cod') : $order->payment_method }}
                        </p>
                    </div>
                </div>
                            ...
                            <div
                                ...
                                <div class="flex items-center justify-between w-full">
                                    <p class="text-base leading-4 text-gray-800 dark:text-gray-400">
                                        {{ __('success.taxes') }}</p>
                                    <p class="text-base leading-4 text-gray-600 dark:text-gray-400">
                                        {{ Number::currency(0, 'EGP') }}</p>
                                </div>
                                <div class="flex items-center justify-between w-full">
                                    <p class="text-base leading-4 text-gray-800 dark:text-gray-400">
                                        {{ __('success.shipping') }}</p>
                                    <p class="text-base leading-4 text-gray-600 dark:text-gray-400">
                                        {{ Number::currency(0, 'EGP') }}</p>
                                </div>
                            </div>
                                ...
                                <div class="flex items-center justify-center space-x-2">
                                    ...
                                    <div class="flex flex-col items-center justify-start">
                                        <p class="text-lg font-semibold leading-6 text-gray-800 dark:text-gray-400">
                                            {{ __('success.delivery') }}<br>
                                            <span class="text-sm font-normal">{{ __('success.delivery_note') }}</span>
                                        </p>
                                    </div>
                                </div>
