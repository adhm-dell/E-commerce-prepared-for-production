<div class="max-w-xl my-3 mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow">
    <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-6">My Account</h2>
    ...
    <form wire:submit.prevent="updateProfile" class="space-y-6">
        <div>
            <label class="block mb-1 text-gray-700 dark:text-gray-300" for="name">Name</label>
        ...
        <div>
            <label class="block mb-1 text-gray-700 dark:text-gray-300" for="email">Email</label>
        ...
        <div>
            <label class="block mb-1 text-gray-700 dark:text-gray-300" for="password">New Password</label>
        ...
        <div>
            <label class="block mb-1 text-gray-700 dark:text-gray-300" for="password_confirmation">Confirm
                Password</label>
