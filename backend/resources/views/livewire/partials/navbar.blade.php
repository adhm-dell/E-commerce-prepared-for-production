    ...
    <nav class="max-w-[85rem] w-full mx-auto px-4 md:px-6 lg:px-8" aria-label="Global">
        <div class="relative md:flex md:items-center md:justify-between">
            <div class="flex items-center justify-between">
                <a class="flex  w-[10rem] text-xl font-bold dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"href="/"
                    aria-label="Brand">
            ...
            <div id="navbar-collapse-with-animation"
                class="hs-collapse hidden fixed top-16 left-0 right-0 z-40 bg-white dark:bg-gray-800 shadow-lg overflow-hidden transition-all duration-300 basis-full grow md:static md:block md:bg-transparent md:shadow-none">
                <div
