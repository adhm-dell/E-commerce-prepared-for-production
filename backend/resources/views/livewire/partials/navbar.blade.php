            ...
            <div id="navbar-collapse-with-animation"
                ...
                <div
                    ...
                    <div
                        ...
                        {{-- Cart --}}
                        <a wire:navigate
                            class="flex font-medium items-center py-3 md:py-6 {{ request()->is('cart') ? 'text-blue-600 dark:text-blue-500 hover:text-gray-400' : 'text-gray-600 dark:text-gray-400 dark:hover:text-gray-500' }}"
                            href="/cart">
