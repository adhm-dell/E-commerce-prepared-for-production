<div>
            ...
            <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                <div class="text-center md:text-left">
                    <h1
                        ...
                        Start your journey with <span class="text-blue-600">FR3ON GYM</span>
                    </h1>
                    <p class="mt-3 text-base sm:text-lg text-gray-800 max-w-2xl mx-auto md:mx-0">
                        Fuel your fitness journey with premium supplements from FR3ON GYM. Discover a wide range of
                        products including Whey Protein, Creatine,<br> Pre-Workout, Fat Burners, and Vitamins —
                        everything
                        you need to build muscle, burn fat, and boost performance.
                    </p>
                    ...
                    <div class="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
                        ...
                        <div class="py-5">
                            <div class="flex space-x-1">
                                ...
                                <svg class="h-4 w-4 text-gray-800 " width="51" height="51" fill="none"
                            ...
                            <p class="mt-3 text-sm text-gray-800 ">
                                <span class="font-bold">4.7</span> /5 - from 12k reviews
                            </p>
                ...
                <div class="relative lg:ml-auto sm:w-sm sm:mx-auto">
        ...
        <div class="max-w-xl mx-auto">
            <div class="text-center ">
                <div class="relative flex flex-col items-center">
                    <h1 class="text-4xl font-bold dark:text-gray-200"> Browse Popular<span class="text-blue-500">
                            Brands
                        </span> </h1>
    ...
    <section class="py-20 ">
        <div class="max-w-xl mx-auto">
            <div class="text-center ">
                <div class="relative flex flex-col items-center">
                    <h1 class="text-4xl font-bold dark:text-gray-200"> Browse Featured<span class="text-blue-500">
                            Products
                        </span> </h1>
                    <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
                        <div class="flex-1 h-2 bg-blue-200">
